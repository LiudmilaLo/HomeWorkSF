...
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ПРАВИЛА ИГРЫ:~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
print("Два игрока (№1 и №2) по очереди ставят на свободные клетки поля 3×3 знаки Х и 0.")
print("Победит тот, кто первым поставит в ряд 3 своих фигуры по вертикали, горизонтали")
print("или диагонали. Игрок №1 ходит за Х, а №2 - за 0.")
...
def move():
    while True:
        ...
        if len(coordinates) != 2:
            print("Координаты должны быть в виде двух чисел. ")
            continue

        x, y = coordinates

        if not(x.isdigit()) or not(y.isdigit()):
            print("Введи координаты в виде двух чисел через пробел: ")
            continue
